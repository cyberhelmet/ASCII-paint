...
public class ASCIIPaint {
    ...
    public static boolean inBounds(int inputRow, int inputColumn, char[][] image) {
        
        if(inputRow >= 0 && inputRow < image.length){
            if(inputColumn >= 0 && inputColumn < image.length ){
                return true;
            }
        }
        return false;
